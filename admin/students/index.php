							  ...
							  <?php if(!empty($_SESSION['tid'])):
								...
								<td>
									<?php if($row1['request']=='A'): echo 'Acitve';
											...
											<a href="http://localhost/tutor/admin/permission/create.php?id=<?= $row['id']?>" class="btn btn-danger btn-sm">Accept</a>
										<?php endif; ?>
								</td>
								...
								<?php endif; ?>
							  <?php endif; ?>
								<td><a href="?id=<?= $row['id']?>" class="btn btn-success btn-sm">Delete</a></td>
							</tr>
					<?php endwhile;
						else: ?>
						<tr>
